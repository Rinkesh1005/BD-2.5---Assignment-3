...
function sortHotelByPrice(hotel1, hotel2, pricing) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  result.sort((hotel1, hotel2) => sortHotelByPrice(hotel1, hotel2, pricing));
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let result = hotels.slice();
  result.sort((hotel1, hotel2) => sortHotelByRating(hotel1, hotel2, rating));

  res.json({ hotels: result });
});

function sortHotelByReview(hotel1, hotel2, reviews) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let result = hotels.slice();
  result.sort((hotel1, hotel2) => sortHotelByReview(hotel1, hotel2, reviews));
